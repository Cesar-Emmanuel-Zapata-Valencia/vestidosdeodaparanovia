function calificar() {
    ...
    if (q7 && q7.value === 'a') {puntuacion++;
    }

    // Pregunta 8
    const q8 = document.querySelector('input[name="q8"]:checked');
    if (q8 && q8.value === 'a') {puntuacion++;
    }

    // Pregunta 9
    const q9 = document.querySelector('input[name="q9"]:checked');
    if (q9 && q9.value === 'false') {
    puntuacion++;
    }

    // Pregunta 10
    const q10 = document.querySelector('input[name="q10"]:checked');
    if (q10 && q10.value === 'b') {puntuacion++;
    }
